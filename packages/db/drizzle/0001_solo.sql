-- 0005_chapters_tags.sql later renames this table to "play_sessions". Guard
-- against resurrecting it on a replay after that rename has already
-- happened — this file replays on every `npm run dev`, same as every other
-- migration here, so IF NOT EXISTS alone isn't enough once the table's name
